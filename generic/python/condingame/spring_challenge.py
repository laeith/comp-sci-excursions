...
# DONT ATTACK MONSTERS IN ENEMY BASE!!!
# IF MONSTERS within threatening range of enemy base then Wind + Shield if mana > 50
...
# TODO: Marcin: Make the closer defender go to the monster attaking base

# Wind -> Shield combo more efficient
# Control of enemy hero if score guaranteed
# TODO: Marcin: Don't attack monsters in enemy base

# Better farming

# TODO: Marcin: Control -> Shield for enemies close to base

# TODO: Marcin: We can actually calculate if more than a single defender is needed (but need to take into account enemy)
...
# TODO: Marcin: Middle defender sticks too hard initially to middle position
...
WEIGHT_MODS = {
    "BASE_THREATENING_DISTANCE": 6500,
...
class Stance(Enum):
    ...
    PRIMARY_DEFENSE = (transpose((MAX_X // 2, MAX_Y // 5)), 300)
    SECONDARY_DEFENSE = (transpose((MAX_X // 5, 2 * MAX_Y // 3)), 300)
    ROAM_MIDDLE = ((MAX_X // 2, MAX_Y // 2), 200)
